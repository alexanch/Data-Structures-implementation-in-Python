...
class Graph(object):
    ...
    def get_adjacency_list_names(self):
        """
        Each section in the list will store a list
        of tuples that looks like this: (To Node Name, Edge Value).
    ...
    def dfs_helper(self, start_node):
        ...
        The output: a list of numbers corresponding to the
        ...
        list_edges = [e for e in start_node.edges if e.node_to.value != start_node.value]
    ...
    def dfs(self, start_node_num):
        """
        Output: a list of numbers corresponding to the traversed nodes
    ...
    def bfs(self, start_node_num):
        """
        Iterative implementation of Breadth First Search iterating through a node's edges. 
        ...
        while queue:
            ...
            for edge_node in node.edges:
                if edge_traversal(node,edge_node):
                    enqueue(edge_node.node_to)
